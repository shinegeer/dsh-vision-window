/**
 * Host half of the dsh-vision-window plugin (v1.1).
 *
...
function sha256Prefix(buf, len = 24) {
...
function patchFromWire(payload) {
  const p = payload || {};
  const patch = pickDefined(p, ['language', 'preset', 'fallbacks', 'downscale', 'downscaleMaxPixels', 'cache', 'cacheTtlSeconds', 'cacheMaxEntries', 'stripThink', 'timeoutMs']);
