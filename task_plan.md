...
- [x] git commit 9e16f5a + push origin/main；后续 commit 765562e（删除 README 横向对比、release 徽章链接、规划文件收尾）
- [x] GitHub Releases：v1.1.0 / v1.2.0 两个 tag + release 已发布
...
- [x] v1.2 commit 9e16f5a + push origin/main（后续 765562e：README 删横向对比 + release 徽章）
- [x] GitHub Releases v1.1.0 / v1.2.0 已发布
